...
def render(beatmap):
    ...
    for i in np.arange(
        0, beatmap.get_duration(), 66.666666666667
    ):  # i in milliseconds, 60 frames per second
        ...
        for obj in objects[::-1]:  # iterate in reverse for stacking
            ...
            if not obj.is_slider():
                ...
                draw.ellipse(
                    xy=[(x_img - radius, y_img - radius), (x_img + radius, y_img + radius)],
                ...
                for p in slider_segment:
                    ...
                    draw.ellipse(
                        xy=[
                            (slider_x - radius, slider_y - radius),
                            (slider_x + radius, slider_y + radius),
                        ],
